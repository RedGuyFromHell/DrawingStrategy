...
{
    public static void Render(Vector3 startPoint, Vector3 endPoint, float time, Color color, LineRenderer line)
    {
        ...
        else
        {
            ...
            line.SetPosition(0, newUpDirection);
